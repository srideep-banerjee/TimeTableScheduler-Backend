...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Teacher t=new Teacher(new HashSet<>(),new HashSet<>(Arrays.asList("ESC501")));
        ...
        t=new Teacher(new HashSet<>(),new HashSet<>(Arrays.asList("PEC-ITB")));
        TeacherDao.getInstance().put("VKS",t);

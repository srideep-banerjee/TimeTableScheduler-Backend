...
public class ChromosomeTest {
    ...
    public ChromosomeTest(String[] subjectCodeArray, String[] teacherNamesArray) {
    ...
    public static void startTest() {
        ChromosomeTest ct = new ChromosomeTest(new String[]{"PCC-CS593", "PCC-CS592", "ESC591", "HSMC-501", "MC501", "PEC-ITB", "RPI", "ESC501", "PCC-CS503", "PCC-CS502", "PCC-CS501", "LET", "GD"}, new String[]{"DG", "SAR", "MRM", "J", "DS", "BR", "SC", "SG", "SBG", "MG", "SS", "AC", "PKC", "SKB", "LKM", "AP", "AS", "PC", "PD", "PKP", "SKHC", "RG", "RKM", "SKS", "TP"});
